...
path_ms = "data/PSData3/Dataset/Dataset/WV-3/test_low_res"
path_pan = "data/PSData3/Dataset/Dataset/WV-3/test_low_res"
...
for file_name_i in list_name:
    ...
    save_dir = 'data/PSData3/model_out/traditional/'
